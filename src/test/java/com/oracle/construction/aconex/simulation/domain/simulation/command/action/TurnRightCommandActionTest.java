...
class TurnRightCommandActionTest {
    ...
    void setUp() throws InvalidCommandException, SimulationRepositoyException {
        ...
        commandAction = new TurnRightCommandAction();
        command = new NavigateCommand("r");
    }


    @Test
    void turnRightFromEast() throws InterruptSimulationException, SimulationException {
    ...
    @Test
    void turnRightFromSouth() throws InterruptSimulationException, SimulationException {
    ...
    @Test
    void turnRightFromWest() throws InterruptSimulationException, SimulationException {
    ...
    @Test
    void turnRightFromNorth() throws InterruptSimulationException, SimulationException {
