...
public enum Item {
    FUEL(1, "fuel usage", new BillItemCalculatorMultiply()), COMMUNICATION(1, "communication overhead", new BillItemCalculatorMultiply()), UNCLEAR_SQUARES(3, "uncleared squares", new BillItemCalculatorMultiply()),
